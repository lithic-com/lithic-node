...
export const parseClientAuthHeaders = (req: IncomingMessage, required?: boolean): Partial<ClientOptions> => { const apiKey = Array.isArray(req.headers['x-lithic-api-key']) ? req.headers['x-lithic-api-key'][0] : req.headers['x-lithic-api-key']
return {apiKey}; }
