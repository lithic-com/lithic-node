...
export const sdkMethods: SdkMethod[] = [{
  ...
  httpMethod: 'get',
  httpPath: '/v2/auth_rules/{auth_rule_token}/versions',
},{
  ...
  httpMethod: 'get',
  httpPath: '/v1/financial_accounts/{financial_account_token}/financial_transactions/{financial_transaction_token}',
},{
