...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: Lithic): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: Lithic): Logger {
