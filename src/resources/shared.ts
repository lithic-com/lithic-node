...
export namespace Document {
  ...
  export interface RequiredDocumentUpload {
     ...
     */
    status_reasons: Array<'DOCUMENT_MISSING_REQUIRED_DATA' | 'DOCUMENT_UPLOAD_TOO_BLURRY' | 'FILE_SIZE_TOO_LARGE' | 'INVALID_DOCUMENT_TYPE' | 'INVALID_DOCUMENT_UPLOAD' | 'INVALID_ENTITY' | 'DOCUMENT_EXPIRED' | 'DOCUMENT_ISSUED_GREATER_THAN_30_DAYS' | 'DOCUMENT_TYPE_NOT_SUPPORTED' | 'UNKNOWN_FAILURE_REASON' | 'UNKNOWN_ERROR'>;
 ...
 */
export type InstanceFinancialAccountType = 'ISSUING' | 'RESERVE' | 'OPERATING' | 'CHARGED_OFF_FEES' | 'CHARGED_OFF_INTEREST' | 'CHARGED_OFF_PRINCIPAL' | 'SECURITY' | 'PROGRAM_RECEIVABLES' | 'COLLECTION' | 'PROGRAM_BANK_ACCOUNTS_PAYABLE' | 'EARLY_DIRECT_DEPOSIT_FLOAT' | 'PROVISIONAL_CREDIT_ACCOUNT'
