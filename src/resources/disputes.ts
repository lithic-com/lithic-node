...
export class Disputes extends APIResource {
   ...
   * ```
   */
  create(body: DisputeCreateParams, options?: RequestOptions): APIPromise<DisputeCreateResponse> {
   ...
   * ```
   */
  retrieve(disputeToken: string, options?: RequestOptions): APIPromise<DisputeRetrieveResponse> {
  ...
  ): APIPromise<DisputeUpdateResponse> {
  ...
  list(
    ...
    return this._client.getAPIList('/v1/disputes', CursorPage<DisputeListResponse>, { query, ...options });
  }
   ...
   * ```
   */
  delete(disputeToken: string, options?: RequestOptions): APIPromise<DisputeDeleteResponse> {
