...
export class V2 extends APIResource {
   ...
   */
  create(body: V2CreateParams, options?: Core.RequestOptions): Core.APIPromise<AuthRule> {
   ...
   */
  retrieve(authRuleToken: string, options?: Core.RequestOptions): Core.APIPromise<AuthRule> {
   ...
   * Lists V2 Auth rules
   */
  list(query?: V2ListParams, options?: Core.RequestOptions): Core.PagePromise<AuthRulesCursorPage, AuthRule>;
  ...
  list(
    ...
    return this._client.getAPIList('/v2/auth_rules', AuthRulesCursorPage, { query, ...options });
  }
   ...
   */
  promote(authRuleToken: string, options?: Core.RequestOptions): Core.APIPromise<AuthRule> {
...
V2.AuthRulesCursorPage = AuthRulesCursorPage;
