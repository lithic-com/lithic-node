...
import { Response, fetch as defaultFetch, type RequestInit, type RequestInfo } from 'lithic/_shims/fetch';
...
describe('retries', () => {
  test('single retry', async () => {
    ...
    const client = new Lithic({ apiKey: 'my api key', timeout: 2000, fetch: testFetch });
