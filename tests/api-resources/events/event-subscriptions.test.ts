...
describe('resource eventSubscriptions', () => {
  test('resend: only required params', async () => {
    const responsePromise = client.events.eventSubscriptions.resend('event_subscription_token', { event_token: 'event_token' });
  ...
  test('resend: required and optional params', async () => {
    const response = await client.events.eventSubscriptions.resend('event_subscription_token', { event_token: 'event_token' });
  });
});
