...
describe('resource cards', () => {
  ...
  test('convertPhysical: only required params', async () => {
    const responsePromise = client.cards.convertPhysical('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { shipping_address: {
    address1: '5 Broad Street',
    city: 'NEW YORK',
    country: 'USA',
    first_name: 'Janet',
  ...
  test('renew: only required params', async () => {
    const responsePromise = client.cards.renew('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { shipping_address: {
    address1: '5 Broad Street',
    city: 'NEW YORK',
    country: 'USA',
    first_name: 'Janet',
