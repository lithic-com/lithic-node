...
describe('resource networkTotals', () => {
  test('retrieve', async () => {
    const responsePromise = client.reports.settlement.networkTotals.retrieve('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');
  ...
  test('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.reports.settlement.networkTotals.list({
