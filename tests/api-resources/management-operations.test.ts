...
describe('resource managementOperations', () => {
  ...
  test('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.managementOperations.list({
  ...
  test('reverse: only required params', async () => {
    const responsePromise = client.managementOperations.reverse('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { effective_date: '2019-12-27' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('reverse: required and optional params', async () => {
    const response = await client.managementOperations.reverse('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { effective_date: '2019-12-27', memo: 'memo' });
  });
});
